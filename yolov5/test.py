...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='test_cam.py')
    ...
    if opt.task in ['val', 'test']:  # run normally
        ...
        # python test_cam.py --task study --data coco.yaml --iou 0.7 --weights yolov5s.pt yolov5m.pt yolov5l.pt yolov5x.pt
